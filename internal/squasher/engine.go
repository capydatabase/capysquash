...
import (
	...
	"github.com/capydatabase/capysquash/internal/builder"
	...
	"github.com/capydatabase/capysquash/internal/tracking/consolidation"
...
func newEngineInternal(engineCfg EngineConfig) (*Engine, error) {
	...
	// (CLI flag, config file, internal/engine config) funnels through here.
...
// consolidation.GetRegistry). Unknown names are an error, never silently ignored.
...
func (e *Engine) generateOptimizedSQL(ctx context.Context, consolidatedObjects map[string]*tracking.ConsolidationResult) (string, error) {
	...
	// Add header comment
	e.sqlBuilder.Comment("Generated by capysquash with modern PostgreSQL patterns")
...
func (e *Engine) generateDataOperationsSQL() (string, error) {
	...
	// Add header comment
	dataBuilder.Comment("Data Operations - Generated by capysquash")
