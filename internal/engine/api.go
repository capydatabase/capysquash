// Package engine is the in-repo façade over the squasher: a small, typed
// entry point (Config, SquashFiles, SquashDirectory, AnalyzeDirectory) that
// the fixture and fuzz suites drive without going through cobra. The CLI in
// internal/cli shares its safety-level parsing. It is not an import surface
// for other modules; capysquash is consumed as a binary.
package engine
...
import (
	...
	internal_config "github.com/capydatabase/capysquash/internal/config"
	internal_parser "github.com/capydatabase/capysquash/internal/parser"
	"github.com/capydatabase/capysquash/internal/plugins/builtin"
	internal_squasher "github.com/capydatabase/capysquash/internal/squasher"
	internal_tracking "github.com/capydatabase/capysquash/internal/tracking"
	internal_types "github.com/capydatabase/capysquash/internal/types"
	internal_utils "github.com/capydatabase/capysquash/internal/utils"
)
...
type Config struct {
	...
	// names must match the catalog served by consolidation.GetRegistry (e.g.
...
// idempotent, so every engine entry point calls this instead of relying
